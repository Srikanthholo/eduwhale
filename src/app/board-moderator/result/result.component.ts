...
export class ResultComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    retriveexam(){
      ...
      this.examservice.get(this.eid)
      .subscribe({
        next: (data) => {
         // this.currentexamresult= data;
          this.currentexam = data;

          this.examname = this.currentexam.title;
          this.examsubject = this.currentexam.subject;
      ...
      retriveReuslts(){
        ...
        this.resultservice.findByexam(this.eid)
        .subscribe({
          next: (data) => {
           // this.currentexamresult= data;
            this.currentexamresult = data.sort((one:any, two :any) => (Number(one.marksobtained) >= Number(two.marksobtained) ? -1 : 1));
